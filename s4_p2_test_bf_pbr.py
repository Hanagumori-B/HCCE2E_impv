...
import numpy as np
from HccePose.bop_loader import BopDataset, TestBopDatasetBackFront
...
if __name__ == '__main__':
    ...
    test_bop_dataset_back_front_item = TestBopDatasetBackFront(bop_dataset_item, train_folder_name, padding_ratio=padding_ratio, ratio=0.01)
