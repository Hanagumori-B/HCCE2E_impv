...
class HccePose_PatchPnP_Loss(HccePose_Loss):
    def __init__(self, size_xyz=None):
        super().__init__()
        self.size_xyz=size_xyz
        self.pm_loss = PyPMLoss(r_only=True, norm_by_extent=True)
    ...
    def forward(self, pred_front, pred_back, pred_mask, 
        ...
        loss_pm = self.pm_loss(pred_rot_mat, gt_rot_mat, model_points, extents=batch_extents)
