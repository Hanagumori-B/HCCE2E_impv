...
def get_conv2d(in_channels, 
    ...
    if attempt_use_lk_impl and need_large_impl:
        ...
        try:
            ...
            raise ImportError('No depthwise_conv2d_implicit_gemm')
...
class DynamicConvBlock(nn.Module):
    ...
    def _forward_inner(self, x, h_x, h_r):
        ...
        weight = weight.view(B, -1, G, H, W).permute(0, 2, 3, 4, 1)
        ...
        value = x.view(B, 2, G, -1, H, W).permute(1, 0, 2, 4, 5, 3)
